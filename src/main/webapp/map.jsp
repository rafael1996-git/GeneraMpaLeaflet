      ...
      <div class="modal-content">
        ...
        map.setView([lati, long],22);
                ...
                $.ajax({
                    type: 'GET',
                    dataType: "json",
	                  url:'http://${pro.ip.jboss.server}:${pro.port.jboss.server}/GeolocCoord/dce/geolcoord?entidad=<%= request.getParameter("entidad") %>&longitud='+long+'&latitud='+lati,
                    crossOrigin: true,
                    beforeSend: function() {
               ...
               function llamaNoUbicacion(){
                $.ajax({
                    type: 'post',
                    dataType: "json",
                   url:'http://${pro.ip.jboss.server}:${pro.port.jboss.server}/WSine-0.0.2/api/enviaSolicitud/',
